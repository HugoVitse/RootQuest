...
>>>>>>> 664eee3f05e69f9b213ec6072d20b14d9509a9d4
const HomePage = () => {
  return (
...
=======
      <header
        className="relative h-[70vh] flex justify-center items-center text-center bg-no-repeat bg-cover bg-center"
        style={{ backgroundImage: 'url("/images/ctf-banner.jpg")' }}
      >
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="relative z-10 px-6 py-12 max-w-4xl mx-auto text-center">
          <h1 className="text-6xl font-extrabold text-white leading-tight mb-4 animate__animated animate__fadeIn animate__delay-1s">
            RootQuest: Plateforme de Pentesting
          </h1>
          <p className="text-lg text-gray-300 mb-8 animate__animated animate__fadeIn animate__delay-1s">
            Améliore tes compétences en cybersécurité avec des défis immersifs,
            seul ou en duo. Prépare-toi à des expériences proches du monde
            professionnel.
>>>>>>> 664eee3f05e69f9b213ec6072d20b14d9509a9d4
          </p>
          <Link href="/register">
...
=======
        <h2 className="text-4xl font-semibold text-blue-400 mb-6">
          Qu'est-ce que RootQuest ?
        </h2>
        <p className="text-xl text-gray-300 max-w-4xl mx-auto">
          RootQuest est une plateforme immersive pour entraîner vos compétences
          en pentesting. Que ce soit en solo ou en duo, chaque challenge simule
          des situations réelles, parfait pour se préparer aux défis futurs.
>>>>>>> 664eee3f05e69f9b213ec6072d20b14d9509a9d4
        </p>
      </section>
...
=======
              <p className="text-lg">
                Teste tes compétences à ton rythme, avec des missions réalistes.
              </p>
>>>>>>> 664eee3f05e69f9b213ec6072d20b14d9509a9d4
...
=======
                Apprends à collaborer efficacement sur des défis plus complexes.
                Développe tes compétences en travail d'équipe.
>>>>>>> 664eee3f05e69f9b213ec6072d20b14d9509a9d4
              </p>
              <div className="absolute inset-0 bg-blue-500 opacity-10 rounded-lg transition-all duration-300 transform group-hover:opacity-30"></div>
            </div>
...
=======
            <p className="text-lg">
              Choisis des défis variés et découvre des problématiques à
              résoudre.
            </p>
>>>>>>> 664eee3f05e69f9b213ec6072d20b14d9509a9d4
            <div className="absolute inset-0 bg-blue-500 opacity-10 rounded-lg transition-all duration-300 transform group-hover:opacity-30"></div>
...
=======
        ...
        <div className="max-w-2xl mx-auto">
          <p className="text-lg italic text-white mb-4">
            "RootQuest m'a permis d'améliorer mes compétences techniques et de
            travailler efficacement avec un partenaire, un atout précieux pour
            ma carrière."
          </p>
          <p className="text-xl text-gray-300">
            - Alice, Analyste en Sécurité Informatique
          </p>
>>>>>>> 664eee3f05e69f9b213ec6072d20b14d9509a9d4
        </div>
      </section>
