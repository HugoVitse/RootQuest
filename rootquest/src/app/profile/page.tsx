...
const ProfilePage: React.FC = () => {
  ...
  const [nbFlags, setNbFlags] = useState<number>(0);
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (response.data.username) {
          ...
          setNbFlags(response.data.nb_flags);
      ...
      <div className="pt-24 px-6 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-6 mt-8">
          <div className="p-6 bg-gray-800 rounded-lg text-center border border-gray-700">
            <p className="text-lg font-semibold">Flags obtenus</p>
          ...
          <div className="p-6 bg-gray-800 rounded-lg text-center border border-gray-700">
            ...
            <p className="text-2xl font-bold text-blue-400">{rank}</p>
          </div>
        </div>
      </div>
